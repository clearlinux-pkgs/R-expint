...
Version  : 0.1.4
Release  : 1
URL      : https://cran.r-project.org/src/contrib/expint_0.1-4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/expint_0.1-4.tar.gz
Summary  : Exponential Integral and Incomplete Gamma Function
Group    : Development/Tools
License  : GPL-2.0+
Requires: R-expint-lib
...
export LANG=C
export SOURCE_DATE_EPOCH=1521199760
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library expint|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/expint/libs/symbols.rds

%files lib
%defattr(-,root,root,-)
/usr/lib64/R/library/expint/libs/expint.so
/usr/lib64/R/library/expint/libs/expint.so.avx2
/usr/lib64/R/library/expint/libs/expint.so.avx512
