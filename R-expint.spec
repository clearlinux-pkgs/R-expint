...
Version  : 0.1.7
Release  : 46
URL      : https://cran.r-project.org/src/contrib/expint_0.1-7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/expint_0.1-7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648499269
